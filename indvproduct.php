...
<body>
    ...
    <div class="container justify-content-center">
        <div class="row">
          <div class="col-3">
            <!--Right Bar-->
            <div class="sidecol"><p style="font-size:25px; color:white;"><strong>Reviews</strong></p><hr style="color:white; height:8px;"/>
                <nav>
                    <ul>
          ...
          <div class="col-3">
            <div class="sidecol"><p style="font-size:25px; color:white;"><strong>Information</strong></p> 
            ...
            <hr style="color:white; height:8px;"/>
            <div class = incol>
                <li>Daily: <p style="color:red">+$0.05</p></li>
                <li>Weekly: <p style="color:red">+$0.07</p></li>
                <li>Monthly: <p style="color:rgb(0, 255, 0)">-$0.10</p></li>
                <li>Annual: <p style="color:red">+$0.02</p></li>
                </div>
                <br>
    ...
    <div class="mx-auto hotcol">
        <p style="font-size:25px; color:white;"><strong>Price Tracker:</strong></p><hr style="color:white; height:8px;"/>
